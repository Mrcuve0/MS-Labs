...
# Created by write_sdc on Sat Jun 15 17:05:55 2019
...
create_clock [get_ports Clk]  -period 9.24  -waveform {0 4.62}
set_max_delay 9.24  -from [list [get_ports Clk] [get_ports Rst] [get_ports {A[31]}] [get_ports    \
